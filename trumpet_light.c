...
#define UART_WRITE_BIT 4
#define UART_READ_PORT PINB
#define UART_READ_BIT 5
...
//                 --------------
//     ISP_MOSI  --|PB0      PA0|-- mic -
//     ISP_MISO  --|PB1      PA1|-- mic +
//     ISP_SCK   --|PB2      PA2|--
//        LED    --|PB3      PA3|--
//               --|VCC      GND|--
//               --|GND     AVCC|--
...
#define XSTR(s) STR(s)
#define STR(s) #s
#define DEV_VERSION "trumpet" TRUMPET_DBG_FLAG " v0.1 r" XSTR(VCS_REVISION)
#define EOL "\r\n"
